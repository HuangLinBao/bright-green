...
var myLineChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: "Sessions",
            lineTension: 0.3,
            backgroundColor: "rgba(69, 175, 13, 0.4)",
            borderColor: "rgba(69, 175, 13, 1)",
            pointRadius: 5,
            pointBackgroundColor: "rgba(69, 175, 13, 1)",
            pointBorderColor: "rgba(255,255,255,0.8)",
            pointHoverRadius: 5,
            pointHoverBackgroundColor: "rgba(69, 175, 13, 1)",
            pointHitRadius: 20,
            pointBorderWidth: 2,
...
var myLineChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: "Revenue",
            backgroundColor: "rgba(69, 175, 13, 1)",
            borderColor: "rgba(69, 175, 13, 1)",
